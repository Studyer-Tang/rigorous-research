...
- Schema-versioned Crossref, OpenAlex, PubMed, and Crossmark-aware integrity checks with deterministic replay fixtures.
- Retraction, correction, expression-of-concern, conflict, coverage-gap, and scholarly-version relationship records.
- Governed AI drafts with local rules, optional user models, field allowlisting, and mandatory human confirmation.
