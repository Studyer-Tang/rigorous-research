...
**Version 1.15 certifies entropy bounds for finite coupling optimizers.** [The next Frankl investigation](examples/frankl-coupling/README.md) rules out a general “stronger inverse weighting always increases entropy” route using disjoint rigorous bounds, and studies a family approaching half frequency. The checker validates optimality error and both marginals; a small solver residual alone is insufficient. Frankl itself remains unresolved.
