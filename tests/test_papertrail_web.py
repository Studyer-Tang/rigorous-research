...
class PaperTrailWebTests(unittest.TestCase):
    ...
    def test_build_site_writes_playground_and_static_demo(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            human_review_js = (output / "assets" / "human-review.js").read_text(encoding="utf-8")
            ...
            self.assertTrue((output / "assets" / "human-review.js").is_file())
        ...
        self.assertIn("review_history", human_review_js)
        self.assertIn("forbiddenReviewer", human_review_js)
        self.assertIn("forbiddenHumanReviewer", app_js)
        self.assertIn("review_history: manifest.reviewHistory", app_js)
        self.assertIn('id="human-review-form"', app)
        self.assertIn("人工审阅台", i18n_js)
        self.assertIn("manual_required", integrity_js)
        self.assertIn("root_version", integrity_js)
